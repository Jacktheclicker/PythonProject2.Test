...
# for tim in anzahl_buchstaben:
#     if tim in anzahl_buchstaben:
#
#     else:
#        print(['fehleingabe'].append(tim))
#
...
for namen in students:
     if namen in students == 'a' or 'A':
        a += 1
print(a)
